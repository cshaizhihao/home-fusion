...
export function YearProgress() {
  ...
  return (
    <div className="home-widget home-widget-progress fixed bottom-4 left-1/2 z-10 w-[min(680px,92vw)] -translate-x-1/2 rounded-md bg-black/35 p-2 text-xs text-white backdrop-blur">
