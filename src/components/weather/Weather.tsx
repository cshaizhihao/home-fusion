...
export const Weather = ({ size = 18 }: { size: number }) => {
  ...
  return (
    <div style={{ backgroundColor: "rgba(var(--mio-main), 0.2)" }} className="fixed right-4 top-4 z-10 flex select-none items-center gap-2 rounded-md px-2 py-1 backdrop-blur">
